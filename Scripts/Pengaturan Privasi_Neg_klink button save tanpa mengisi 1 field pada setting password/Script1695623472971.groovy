...
WebUI.takeScreenshot(ss + "Pengaturan Privasi_Neg_Klik button save tanpa mengisi 1 field pada satting password_1.png")
WebUI.refresh()
WebUI.setText(findTestObject("TxtField/Field_passbaru"),pass)
WebUI.setText(findTestObject("TxtField/Field_passulangbaru"),pass)
WebUI.click(findTestObject("Button/btn_simpanpass"))
WebUI.takeScreenshot(ss + "Pengaturan Privasi_Neg_Klik button save tanpa mengisi 1 field pada satting password_2.png")
WebUI.refresh()
WebUI.setText(findTestObject("TxtField/Field_passlama"),pass)
WebUI.setText(findTestObject("TxtField/Field_passulangbaru"),pass)
WebUI.click(findTestObject("Button/btn_simpanpass"))
WebUI.takeScreenshot(ss + "Pengaturan Privasi_Neg_Klik button save tanpa mengisi 1 field pada satting password_3.png")