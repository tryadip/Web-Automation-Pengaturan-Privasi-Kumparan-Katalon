...
WebUI.setText(findTestObject("TxtField/Field_passlama"),"bukan password")
...
WebUI.takeScreenshot(ss + "Pengaturan Privasi_Neg_Input semua field dan klik button save dengan invalid password_1.png")
