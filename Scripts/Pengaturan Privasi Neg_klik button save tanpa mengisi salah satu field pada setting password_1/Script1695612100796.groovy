...
WebUI.takeScreenshot(ss + "Pengaturan Privasi_Neg_Klik button save tanpa mengisi salah satu field pada setting password_1.png")
WebUI.refresh()
WebUI.setText(findTestObject("TxtField/Field_passbaru"),pass)
WebUI.click(findTestObject("Button/btn_simpanpass"))
WebUI.takeScreenshot(ss + "Pengaturan Privasi_Neg_Klik button save tanpa mengisi salah satu field pada setting password_2.png")
WebUI.refresh()
WebUI.setText(findTestObject("TxtField/Field_passulangbaru"),pass)
WebUI.click(findTestObject("Button/btn_simpanpass"))
WebUI.takeScreenshot(ss + "Pengaturan Privasi_Neg_Klik button save tanpa mengisi salah satu field pada setting password_3.png")